          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              ...
              <div className="font-display text-xl font-bold tracking-wider sm:text-2xl">
                ROLETA CORRETOR <span className="text-orange">|</span> <span className="font-light">SIMULADOR CORRETOR</span>
              </div>
              <div className="text-[10px] font-semibold uppercase tracking-[0.3em] text-orange">
                Elite 4.0
              </div>
            </div>
          </Link>
